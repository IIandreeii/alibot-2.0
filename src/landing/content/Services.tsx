...
export const Services = () => {
  return (
    <div className="mx-auto p-4 text-white flex flex-col gap-5">
      <h3 className="text-transparent bg-clip-text bg-gradient-to-r from-purple-700 to-blue-800 text-center text-5xl max-md:text-3xl mb-10">
        ¿Te identificas con esto?
      </h3>
      <div className="space-y-4 w-full flex flex-col gap-y-10">
        <div className='w-[57%] m-auto text-[20px] leading-[45px] font-semibold max-md:w-[90%] max-md:text-[18px] max-md:leading-[30px] flex flex-col gap-5'>
        ...
        <div className="flex justify-center items-center md:gap-[70px] flex-wrap max-md:gap-5">
