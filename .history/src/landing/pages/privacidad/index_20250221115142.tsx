  ...
  return (
    <div className={container}>
      ...
      <div className={containerDetail}>
        <div>
        <h4 className="my-4">Introducción</h4>
          <p>
          ...
          <h4 className="my-4">Información personal</h4>
          <p>
          ...
          <h4 className="my-4">¿Qué datos personales se recogen?</h4>
          ...
          <h4 className="my-4">What organizations are collecting the information?</h4>
          ...
          <h4 className="my-4">How does the Site use Personally Identifiable Information?</h4>
          ...
          <h4 className="my-4">With whom the information may be shared?</h4>
          <p>Personally Identifiable Information about Authorized Customers may be shared with other Authorized Customers who wish to evaluate potential transactions with other Authorized Customers. We may share aggregated information about our Visitors, including the demographics of our Visitors and Authorized Customers, with third party vendors.</p>

          <h4 className="my-4">How is Personally Identifiable Information stored?</h4>
          ...
          <h4 className="my-4">What choices are available to Visitors regarding collection, use and distribution of the information?</h4>
          ...
          <h4 className="my-4">Are Cookies Used on the Site?</h4>
          ...
          <h4 className="my-4">How does This APP use login information?</h4>
          ...
          <h4 className="my-4">What partners or service providers have access to Personally Identifiable Information from Visitors and/or Authorized Customers on the Site?</h4>
          ...
          <h4 className="my-4">How does the Site keep Personally Identifiable Information secure?</h4>
          ...
          <h4 className="my-4">How can Visitors correct any inaccuracies in Personally Identifiable Information?</h4>
          ...
          <h4 className="my-4">Can a Visitor delete or deactivate Personally Identifiable Information collected by the Site?</h4>
          ...
          <h4 className="my-4">What happens if the Privacy Policy Changes?</h4>
